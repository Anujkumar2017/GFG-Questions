...
public:
    ...
    Node* solve(int start, int end, int n, int &preIndex, int inOrder[], int preOrder[]){
        ...
        node->left=solve(start,inIndex-1,n,preIndex,inOrder,preOrder);
        node->right=solve(inIndex+1,end,n,preIndex,inOrder,preOrder);
    ...
    Node* post_order(int pre[], int n)
    {
        //code here
        int preOrder[n];
        copy(pre,pre+n,preOrder);
        sort(pre,pre+n);
        
        int inOrder[n];
        copy(pre,pre+n,inOrder);
        
        int start=0,end=n-1;
        int preIndex=0;
        Node* root=solve(start,end,n,preIndex,inOrder,preOrder);
        return root;
    }
};
